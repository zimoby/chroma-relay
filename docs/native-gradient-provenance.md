...
Chroma Relay owns product semantics, UI, CEP bridge, and future runtime adapters under `com.zimoby.chroma-relay`. The standalone `@zimoby/ae-native-gradient` package independently owns the toolkit implementation.
